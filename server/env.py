...
class SREEnvironment:
    def __init__(self):
        # We read which task to run from the environment variables. 
        # The OpenEnv validation runner will cycle through these automatically.
    ...
    def reset(self) -> SREObservation:
        """Starts a new episode, resetting state and returning the initial observation."""
        self.step_count = 0
